<%-- 
    Document   : searchCars
    Created on : Mar 4, 2021, 3:20:13 PM
    Author     : WIN
--%>
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search cars..." name="txtSearch" value="${param.txtSearch}">                                        
                                    </div>
                                    <!-- Price -->
                ...
                <div class="col-sm-8 col-md-9">
                        ...
                        <div class="row">
                            ...
                            <c:if test="${not empty user}">
                                ...
                                <div class="col-md-4" style="padding-left: 25px;">
                                    <a class="btn btn-primary" href="viewCartJSP">Your cart
                    ...
                    <div class="row">
                        ...
                        <!-- Search cars-->
                        <c:forEach var="cars" items="${sessionScope.LISTCARSEARCH}">
                    ...
                    <div class="row" style="float: right">
                        <div class="col-sm-12">
                            <ul class="pagination">
                                <c:forEach var="sizeOfPageBySearch" begin="1" end="${sessionScope.SIZEOFPAGESEACH}">
                                    <li class="page-item">
                                        <c:url var="SearchCars" 
                                               value="searchCars?txtSearch=${param.txtSearch}&txtPriceFrom=${param.txtPriceFrom}&txtPriceTo=${param.txtPriceTo}&pageIndex=${sizeOfPageBySearch}"/>
                                        <a class="page-link" 
                                           href="${SearchCars}">${sizeOfPageBySearch}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
